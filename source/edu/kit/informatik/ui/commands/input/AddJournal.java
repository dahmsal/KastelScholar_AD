...
public class AddJournal extends Command {
    ...
    public AddJournal(final Session session, final Database database) {
        ...
        Parameter journal = new Parameter.ParameterBuilder().pattern(Pattern.STRING).build();
        Parameter publisher = new Parameter.ParameterBuilder().pattern(Pattern.STRING).build();
